...
const Animation_ts_1 = require("./Animation.ts");
const Direction_ts_1 = require("./Direction.ts");
const Frame_ts_1 = require("./Frame.ts");
const Rect_ts_1 = require("./Rect.ts");
const Static_ts_1 = require("./Static.ts");
class Sprite extends Rect_ts_1.Rect {
    constructor() {
        super();
    ...
    get angle() {
        return Static_ts_1.Static.toDegrees(Math.atan2(this.speedY, this.speedX));
    }
    get direction() {
        const DIRECTION = new Direction_ts_1.Direction();
    ...
    setImage(image) {
        this.setAnimation(new Animation_ts_1.Animation([new Frame_ts_1.Frame(image)]));
        return this;
    }
    set image(image) {
        this.setImage(image);
    ...
    setSpeedToAngle(speed, degrees) {
        const RADIANS = Static_ts_1.Static.toRadians(degrees);
